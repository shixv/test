...
//	}
	int *array=NULL;
	InitPrimeFile(100,FILENAM);
	AttendPrimeFile(60,FILENAM);
	array=ReadPrimeFile(1,160,FILENAM);
	PrintPrimeArray(array,160);
	int n=SearchPrimeFile(20,100,FILENAM,&array);
